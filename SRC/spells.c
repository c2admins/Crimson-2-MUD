...
void assign_spell_pointers(void)
{
	...
	SPELLO(163, 12, POSITION_FIGHTING, 25, 0,
	       ENABLED_SPELL | MOB_SPELL | HELPFUL_SPELL,
	0, APPLY_NONE, AFF2_DETECT_GIANTS, TAR_CHAR_ROOM, cast_detect_giants);
	...
	SPELLO(165, 12, POSITION_FIGHTING, 25, 0,
	       ENABLED_SPELL | MOB_SPELL | HELPFUL_SPELL,
	0, APPLY_NONE, AFF2_DETECT_SHADOWS, TAR_CHAR_ROOM, cast_detect_shadows);
	...
	SPELLO(169, 12, POSITION_FIGHTING, 25, 0,
	       ENABLED_SPELL | MOB_SPELL | HELPFUL_SPELL,
	0, APPLY_NONE, AFF2_DETECT_DEMONS, TAR_CHAR_ROOM, cast_detect_demons);

	SPELLO(170, 12, POSITION_FIGHTING, 25, 0,
	       ENABLED_SPELL | MOB_SPELL | HELPFUL_SPELL,
	0, APPLY_NONE, AFF2_DETECT_DRAGONS, TAR_CHAR_ROOM, cast_detect_dragons);
	...
	SPELLO(173, 12, POSITION_FIGHTING, 25, 0,
	       ENABLED_SPELL | MOB_SPELL | HELPFUL_SPELL,
	0, APPLY_NONE, AFF2_DETECT_UNDEAD, TAR_CHAR_ROOM, cast_detect_vampires);
