...
void assign_spell_pointers(void)
{
	...
	SPELLO(130, 12, POSITION_FIGHTING, 25, 0,
	       ENABLED_SPELL | MOB_SPELL | HELPFUL_SPELL,
	0, APPLY_NONE, 0, TAR_CHAR_ROOM, cast_detect_animals);
	...
	SPELLO(163, 12, POSITION_FIGHTING, 25, 0,
	       ENABLED_SPELL | MOB_SPELL | HELPFUL_SPELL,
	0, APPLY_NONE, 0, TAR_CHAR_ROOM, cast_detect_giants);

	SPELLO(164, 12, POSITION_STANDING, 20, 0,
	       ENABLED_SPELL | MOB_SPELL | VIOLENT_SPELL,
	   0, APPLY_NONE, 0, TAR_IGNORE, cast_faerie_fog);

	SPELLO(165, 12, POSITION_FIGHTING, 25, 0,
	       ENABLED_SPELL | MOB_SPELL | HELPFUL_SPELL,
	0, APPLY_NONE, 0, TAR_CHAR_ROOM, cast_detect_shadows);

	SPELLO(166, 12, POSITION_STANDING, 20, 0,
	       ENABLED_SPELL | MOB_SPELL | HELPFUL_SPELL,
	       0, APPLY_NONE, 0, TAR_SELF_ONLY, cast_barkskin);

	SPELLO(167, 12, POSITION_STANDING, 25, 0,
	       ENABLED_SPELL | MOB_SPELL | HELPFUL_SPELL,
	       0, APPLY_NONE, 0, TAR_SELF_ONLY, cast_stoneskin);

	SPELLO(168, 12, POSITION_STANDING, 25, 0,
	       ENABLED_SPELL | MOB_SPELL | VIOLENT_SPELL,
	   0, APPLY_NONE, 0, TAR_CHAR_ROOM | TAR_FIGHT_VICT, cast_thornwrack);

	SPELLO(169, 12, POSITION_FIGHTING, 25, 0,
	       ENABLED_SPELL | MOB_SPELL | HELPFUL_SPELL,
	0, APPLY_NONE, 0, TAR_CHAR_ROOM, cast_detect_demons);

	SPELLO(170, 12, POSITION_FIGHTING, 25, 0,
	       ENABLED_SPELL | MOB_SPELL | HELPFUL_SPELL,
	0, APPLY_NONE, 0, TAR_CHAR_ROOM, cast_detect_dragons);
	
	SPELLO(171, 12, POSITION_FIGHTING, 25, 0,
	       ENABLED_SPELL | MOB_SPELL | HELPFUL_SPELL,
	0, APPLY_NONE, 0, TAR_CHAR_ROOM, cast_detect_undead);

	SPELLO(172, 12, POSITION_STANDING, 50, 0,
	       ENABLED_SPELL | MOB_SPELL | HELPFUL_SPELL,
	       0, APPLY_NONE, 0, TAR_IGNORE, cast_animal_summoning);

	SPELLO(173, 12, POSITION_FIGHTING, 25, 0,
	       ENABLED_SPELL | MOB_SPELL | HELPFUL_SPELL,
	0, APPLY_NONE, 0, TAR_CHAR_ROOM, cast_detect_vampires);
